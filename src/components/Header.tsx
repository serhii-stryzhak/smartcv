...
export const Header = ({ personal }: HeaderProps) => (
  <header className="relative flex flex-col md:flex-row print:flex-row items-center md:items-start print:items-start gap-6 md:gap-8 print:gap-6 pb-8 border-b border-border">
    <ThemeToggle />
    {personal.photo && (
    ...
    <div className="text-center md:text-left print:text-left">
      <h1 className="text-3xl md:text-4xl lg:text-5xl print:text-3xl font-bold text-primary mb-2">
        {personal.name}
      </h1>
      <p className="text-xl md:text-2xl print:text-xl text-secondary mb-3">{personal.title}</p>
